    ...
    return (
        <div>
            <div className='bg-[#f7f7f7] pb-24'>
                ...
                {/* details div */}
                <div className="w-11/12 mx-auto flex flex-col md:flex-row justify-center items-center bg-white rounded-3xl shadow-lg -mt-32 p-8">
                    <div className='space-y-4 basis-[70%] md:w-2/5 h-full'>
                        <img className="w-11/12 rounded-md shadow-lg" src={filteredAdventure.image} alt={`${filteredAdventure.title}`} />
                    </div>
                    <div className='space-y-4 basis-[70%] md:w-3/5'>
